  ...
  return (
    <>
      ...
      <div className="helloText">
        <p
          className="headText"
          style={animatedElements ? { animation: "none" } : {}}
        >
        ...
        <p style={animatedElements ? { animation: "none" } : {}}>
          ...
          europejskim, amerykańskim, azjatyckim oraz w Australii. Zawodnik,
          ...
          roku Andrea Iannone na torze w Mugello osiągnął prędkość 354,9 km/h,
          co jest rekordem prędkości w historii MotoGP. Hałas o natężeniu 130
          decybeli, jaki wytwarzają, zmusza kierowców do używania stopperów. W
          sezonach 2007–2011 wszystkie motocykle w najwyższej klasie były
          wyposażone w silniki o pojemności zmniejszonej z 990 cm³ do 800 cm³.
          Powodem były zbyt wysokie prędkości osiągane na torze przez
          zawodników. Kolejnym była śmierć w 2003 roku japońskiego motocyklisty
          Daijiro Kato po wypadku na japońskim torze Suzuka. Obecnie w MotoGP
          wyróżnić można 6 producentów: Yamaha, Honda, Ducati, Suzuki, Aprilia
          oraz KTM. Od sezonu 2012 pojemność motocykli w klasie MotoGP wynosi
          1000 cm³.
        </p>
      </div>
    </>
